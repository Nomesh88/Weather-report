...
function getData(location) {
    let loc = location;
    let url = `http://api.openweathermap.org/data/2.5/weather?q=${loc}&appid=929164c093e6b80f20bde3b0128901a6 `;
...
searchBox.addEventListener("keypress", (e) => {
    if (e.which === 13) {
        ...
        if (searchVal === "") {
            ...
            searchVal[0] = searchVal[0].toUpperCase();//first letter has to be capital
